...
document.querySelector('a-scene').addEventListener('loaded', function () {
  ...
  */
  ...
  window.setPlayerSpawnData = data=>{
    player.body.el.setAttribute("position",`${data.x} ${data.y} ${data.z}`);
    player.body.el.setAttribute("velocity","0 1 0");
    // player.systems.physics.driver.world.gravity.y = 0;
    // window.setTimeout(()=>{
    //  player.systems.physics.driver.world.gravity.y = -1.62;
    // },3000);
    //player.body.el.setAttribute("rotation",`0 ${data.ry} 0`);
  }
